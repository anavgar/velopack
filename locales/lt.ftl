...
splash-body = Nustatoma { $app_title }, palaukite...
...
msi-dlg-title = { $app_title } { $app_version } sąranka
msi-btn-back = &Atgal
msi-btn-next = &Pirmyn
...
msi-welcome-title = Sveiki! Čia { $app_title } { $app_version } sąrankos vedlys
msi-welcome-description = Sąrankos vedlys įdiegs { $app_title } { $app_version } jūsų kompiuteryje. Spustelėkite Pirmyn, norėdami tęsti, arba spustelėkite Atšaukti, norėdami uždaryti sąrankos vedlį.
msi-welcome-update-description = Sąrankos vedlys atnaujins { $app_title } { $app_version } jūsų kompiuteryje. Spustelėkite Pirmyn, norėdami tęsti, arba spustelėkite Atšaukti, norėdami uždaryti sąrankos vedlį.

# MSI Installer UI - Exit Dialog
msi-exit-title = Atlikti { $app_title } { $app_version } sąrankos vedlio nurodymai
msi-exit-description = Norėdami uždaryti sąrankos vedlį, spustelėkite mygtuką Baigti.
msi-exit-launch-checkbox = Paleisti { $app_title } { $app_version }

# MSI Installer UI - Prepare Dialog
msi-prepare-title = Sveiki! Čia { $app_title } { $app_version } sąrankos vedlys
...
msi-ready-install-title = Parengta diegti { $app_title } { $app_version }
...
msi-ready-change-title = Parengta keisti { $app_title } { $app_version }
...
msi-ready-repair-title = Parengta taisyti { $app_title } { $app_version }
...
msi-ready-remove-title = Parengta pašalinti { $app_title } { $app_version }
msi-ready-remove-text = Norėdami pašalinti { $app_title } { $app_version } iš savo kompiuterio, spustelėkite mygtuką Šalinti. Norėdami peržiūrėti ar pakeisti bet kurį diegimo parametrą, spustelėkite mygtuką Atgal.
msi-ready-update-title = Parengta naujinti { $app_title } { $app_version }
...
msi-progress-installing-title = { $app_title } { $app_version } diegimas
msi-progress-installing-text = Palaukite, kol sąrankos vedlys įdiegs { $app_title } { $app_version }.
msi-progress-changing-title = { $app_title } { $app_version } keitimas
msi-progress-changing-text = Palaukite, kol sąrankos vedlys pakeis { $app_title } { $app_version }.
msi-progress-repairing-title = { $app_title } { $app_version } taisymas
msi-progress-repairing-text = Palaukite, kol sąrankos vedlys pataisys { $app_title } { $app_version }.
msi-progress-removing-title = { $app_title } { $app_version } šalinimas
msi-progress-removing-text = Palaukite, kol sąrankos vedlys pašalins { $app_title } { $app_version }.
msi-progress-updating-title = { $app_title } { $app_version } naujinimas
msi-progress-updating-text = Palaukite, kol sąrankos vedlys atnaujins { $app_title } { $app_version }.
msi-progress-status = Būsena:

# MSI Installer UI - Maintenance Welcome Dialog
msi-maint-welcome-title = Sveiki! Čia { $app_title } { $app_version } sąrankos vedlys
msi-maint-welcome-description = Sąrankos vedlys leis taisyti arba šalinti { $app_title } { $app_version }. Spustelėkite Pirmyn, norėdami tęsti, arba spustelėkite Atšaukti, norėdami uždaryti sąrankos vedlį.
...
msi-maint-remove-text = Pašalina { $app_title } { $app_version } iš kompiuterio.
msi-maint-remove-disabled = Šiuo metu šalinti negalima.

# MSI Installer UI - Cancel Dialog
msi-cancel-text = Ar tikrai norite atšaukti { $app_title } { $app_version } diegimą?
...
msi-error-dlg-title = { $app_title } { $app_version } diegimo programos informacija

# MSI Installer UI - Fatal Error Dialog
msi-fatal-title = { $app_title } { $app_version } sąrankos vedlys nutrūko per anksti
msi-fatal-description1 = { $app_title } { $app_version } sąranka buvo nutraukta. Jūsų sistema nepakeista. Norėdami įdiegti šią programą vėliau, paleiskite sąranką dar kartą.
msi-fatal-description2 = Norėdami uždaryti sąrankos vedlį, spustelėkite mygtuką Baigti.

# MSI Installer UI - User Exit Dialog
msi-user-exit-title = { $app_title } { $app_version } sąrankos vedlio darbas nutrūko
msi-user-exit-description1 = { $app_title } { $app_version } sąranka buvo nutraukta. Jūsų sistema nepakeista. Norėdami įdiegti šią programą vėliau, paleiskite sąranką dar kartą.
...
msi-resume-title = { $app_title } { $app_version } sąrankos vedlys tęsia darbą
msi-resume-description = Sąrankos vedlys baigs diegti { $app_title } { $app_version } jūsų kompiuteryje. Norėdami tęsti, spustelėkite mygtuką Diegti, o norėdami išeiti iš sąrankos vedlio, spustelėkite mygtuką Atšaukti.
msi-resume-btn-install = &Diegti

# MSI Installer UI - Shortcut Descriptions
msi-desktop-shortcut-description = { $app_title } { $app_version } darbalaukio sparčioji nuoroda
msi-start-menu-shortcut-description = { $app_title } { $app_version } meniu Pradžia sparčioji nuoroda
