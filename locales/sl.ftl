...
splash-body = Nastavitev { $app_title }, počakajte...
...
msi-dlg-title = Namestitev programa { $app_title } { $app_version }
msi-btn-back = &Nazaj
msi-btn-next = &Naprej
...
msi-welcome-title = Dobrodošli v čarovniku za namestitev programa { $app_title } { $app_version }
msi-welcome-description = Čarovnik za namestitev bo v računalnik namestil { $app_title } { $app_version }. Kliknite »Naprej« za nadaljevanje ali »Prekliči« za izhod iz čarovnika za namestitev.
msi-welcome-update-description = Čarovnik za namestitev bo posodobil { $app_title } { $app_version } v računalniku. Kliknite »Naprej«, če želite nadaljevati ali »Prekliči«, če želite zapreti čarovnika za namestitev.

# MSI Installer UI - Exit Dialog
msi-exit-title = Čarovnik za namestitev programa { $app_title } { $app_version } je dokončan
msi-exit-description = Če želite zapreti čarovnika za namestitev, kliknite gumb »Dokončaj«.
msi-exit-launch-checkbox = Zaženi { $app_title } { $app_version }

# MSI Installer UI - Prepare Dialog
msi-prepare-title = Dobrodošli v čarovniku za namestitev programa { $app_title } { $app_version }
...
msi-ready-install-title = Pripravljen na namestitev programa { $app_title } { $app_version }
...
msi-ready-change-title = Pripravljen na spreminjanje programa { $app_title } { $app_version }
...
msi-ready-repair-title = Pripravljen na popravljanje programa { $app_title } { $app_version }
...
msi-ready-remove-title = Pripravljen na odstranjevanje programa { $app_title } { $app_version }
msi-ready-remove-text = Kliknite »Odstrani«, če želite odstraniti program { $app_title } { $app_version } iz računalnika. Kliknite »Nazaj«, če želite pregledati ali spremeniti nastavitve namestitve.
msi-ready-update-title = Pripravljen na posodobitev programa { $app_title } { $app_version }
...
msi-progress-installing-title = Namestitev programa { $app_title } { $app_version }
msi-progress-installing-text = Počakajte, da čarovnik za namestitev namesti program { $app_title } { $app_version }.
msi-progress-changing-title = Spreminjanje programa { $app_title } { $app_version }
msi-progress-changing-text = Počakajte, da čarovnik za namestitev spremeni program { $app_title } { $app_version }.
msi-progress-repairing-title = Popravljanje programa { $app_title } { $app_version }
msi-progress-repairing-text = Počakajte, da čarovnik za namestitev popravi program { $app_title } { $app_version }.
msi-progress-removing-title = Odstranjevanje programa { $app_title } { $app_version }
msi-progress-removing-text = Počakajte, da čarovnik za namestitev odstrani program { $app_title } { $app_version }.
msi-progress-updating-title = Posodabljanje programa { $app_title } { $app_version }
msi-progress-updating-text = Počakajte, da čarovnik za namestitev posodobi program { $app_title } { $app_version }.
msi-progress-status = Stanje:

# MSI Installer UI - Maintenance Welcome Dialog
msi-maint-welcome-title = Dobrodošli v čarovniku za namestitev programa { $app_title } { $app_version }
msi-maint-welcome-description = Čarovnik za namestitev omogoča popravljanje ali odstranjevanje programa { $app_title } { $app_version }. Če želite nadaljevati, kliknite »Naprej« ali »Prekliči«, če želite zapreti čarovnika za namestitev.
...
msi-maint-remove-text = Odstrani program { $app_title } { $app_version } iz računalnika.
msi-maint-remove-disabled = Odstranjevanje je trenutno onemogočeno.

# MSI Installer UI - Cancel Dialog
msi-cancel-text = Ali ste prepričani, da želite preklicati namestitev programa { $app_title } { $app_version }?
...
msi-error-dlg-title = Informacije namestitvenega programa { $app_title } { $app_version }

# MSI Installer UI - Fatal Error Dialog
msi-fatal-title = Čarovnik za namestitev programa { $app_title } { $app_version } se je predčasno končal
msi-fatal-description1 = Namestitev programa { $app_title } { $app_version } je bila prekinjena. Sistem ni bil spremenjen. Če želite ta program namestiti pozneje, znova zaženite namestitev.
msi-fatal-description2 = Če želite zapreti čarovnika za namestitev, kliknite gumb »Dokončaj«.

# MSI Installer UI - User Exit Dialog
msi-user-exit-title = Čarovnik za namestitev programa { $app_title } { $app_version } je bil prekinjen
msi-user-exit-description1 = Namestitev programa { $app_title } { $app_version } je bila prekinjena. Sistem ni bil spremenjen. Če želite ta program namestiti pozneje, znova zaženite namestitev.
...
msi-resume-title = Nadaljevanje izvajanja čarovnika za namestitev programa { $app_title } { $app_version }
msi-resume-description = Čarovnik za namestitev bo dokončal namestitev programa { $app_title } { $app_version } v računalnik. Če želite nadaljevati, kliknite »Namesti« ali »Prekliči«, če želite zapreti čarovnika za namestitev.
msi-resume-btn-install = &Namesti

# MSI Installer UI - Shortcut Descriptions
msi-desktop-shortcut-description = Namizna bližnjica za { $app_title } { $app_version }
msi-start-menu-shortcut-description = Bližnjica v meniju Start za { $app_title } { $app_version }
