...
splash-body = Установка { $app_title }, пожалуйста, подождите…
...
setup-disk-space-insufficient = Для установки { $app_title } требуется не менее { $required_space } свободного места на диске. Доступно только { $available_space }.
setup-windows-version-unsupported = Для этого установщика требуется Windows 7 SP1 или новее, запуск невозможен.
setup-embedded-zip-missing = Не удалось найти встроенный zip-архив. Обратитесь к разработчику приложения.
setup-os-version-required = Для этого приложения требуется Windows { $os_version } или новее.
setup-cpu-arch-unsupported = Это приложение ({ $machine_arch }) не поддерживает архитектуру вашего процессора.
setup-stop-app-failed = Не удалось остановить приложение ({ $error }). Закройте приложение и снова запустите установщик.
setup-remove-dir-failed = Не удалось удалить существующую папку приложения. Закройте приложение и снова запустите установщик. Если проблема сохраняется, попробуйте сначала удалить приложение через «Программы и компоненты» или перезагрузить компьютер.
setup-update-exe-missing = В этом установщике отсутствует важный исполняемый файл (Update.exe). Обратитесь к разработчику приложения.
setup-main-exe-missing = Не удалось найти основной исполняемый файл в пакете. Обратитесь к разработчику приложения.

# MSI Installer UI - Common
msi-dlg-title = Установка { $app_title } { $app_version }
msi-btn-back = &Назад
msi-btn-next = &Далее
...
msi-welcome-title = Добро пожаловать в мастер установки { $app_title } { $app_version }
msi-welcome-description = Мастер установки установит { $app_title } { $app_version } на ваш компьютер. Нажмите «Далее» для продолжения или «Отмена» для выхода из мастера установки.
msi-welcome-update-description = Мастер установки обновит { $app_title } { $app_version } на вашем компьютере. Нажмите «Далее» для продолжения или «Отмена» для выхода из мастера установки.

# MSI Installer UI - Exit Dialog
msi-exit-title = Мастер установки { $app_title } { $app_version } завершён
msi-exit-description = Нажмите кнопку «Готово» для выхода из мастера установки.
msi-exit-launch-checkbox = Запустить { $app_title } { $app_version }

# MSI Installer UI - Prepare Dialog
msi-prepare-title = Добро пожаловать в мастер установки { $app_title } { $app_version }
...
msi-ready-install-title = Всё готово для установки { $app_title } { $app_version }
...
msi-ready-change-title = Всё готово для изменения { $app_title } { $app_version }
...
msi-ready-repair-title = Всё готово для восстановления { $app_title } { $app_version }
...
msi-ready-remove-title = Всё готово для удаления { $app_title } { $app_version }
msi-ready-remove-text = Нажмите «Удалить» для удаления { $app_title } { $app_version } с вашего компьютера. Нажмите «Назад» для просмотра или изменения параметров.
msi-ready-update-title = Всё готово для обновления { $app_title } { $app_version }
...
msi-progress-installing-title = Установка { $app_title } { $app_version }
msi-progress-installing-text = Пожалуйста, подождите, пока мастер установки устанавливает { $app_title } { $app_version }.
msi-progress-changing-title = Изменение { $app_title } { $app_version }
msi-progress-changing-text = Пожалуйста, подождите, пока мастер установки изменяет { $app_title } { $app_version }.
msi-progress-repairing-title = Восстановление { $app_title } { $app_version }
msi-progress-repairing-text = Пожалуйста, подождите, пока мастер установки восстанавливает { $app_title } { $app_version }.
msi-progress-removing-title = Удаление { $app_title } { $app_version }
msi-progress-removing-text = Пожалуйста, подождите, пока мастер установки удаляет { $app_title } { $app_version }.
msi-progress-updating-title = Обновление { $app_title } { $app_version }
msi-progress-updating-text = Пожалуйста, подождите, пока мастер установки обновляет { $app_title } { $app_version }.
msi-progress-status = Состояние:

# MSI Installer UI - Maintenance Welcome Dialog
msi-maint-welcome-title = Добро пожаловать в мастер установки { $app_title } { $app_version }
msi-maint-welcome-description = Мастер установки позволит вам восстановить или удалить { $app_title } { $app_version }. Нажмите «Далее» для продолжения или «Отмена» для выхода из мастера установки.
...
msi-maint-remove-text = Удаляет { $app_title } { $app_version } с вашего компьютера.
msi-maint-remove-disabled = Удаление в настоящее время недоступно.

# MSI Installer UI - Cancel Dialog
msi-cancel-text = Вы уверены, что хотите отменить установку { $app_title } { $app_version }?
...
msi-error-dlg-title = { $app_title } { $app_version } — Информация установщика

# MSI Installer UI - Fatal Error Dialog
msi-fatal-title = Мастер установки { $app_title } { $app_version } завершился преждевременно
msi-fatal-description1 = Установка { $app_title } { $app_version } была прервана. Ваша система не была изменена. Для установки программы позже запустите установку повторно.
msi-fatal-description2 = Нажмите кнопку «Готово» для выхода из мастера установки.

# MSI Installer UI - User Exit Dialog
msi-user-exit-title = Мастер установки { $app_title } { $app_version } был прерван
msi-user-exit-description1 = Установка { $app_title } { $app_version } была прервана. Ваша система не была изменена. Для установки программы позже запустите установку повторно.
...
msi-resume-title = Возобновление мастера установки { $app_title } { $app_version }
msi-resume-description = Мастер установки завершит установку { $app_title } { $app_version } на ваш компьютер. Нажмите «Установить» для продолжения или «Отмена» для выхода из мастера установки.
msi-resume-btn-install = &Установить

# MSI Installer UI - Shortcut Descriptions
msi-desktop-shortcut-description = Ярлык { $app_title } { $app_version } на рабочем столе
msi-start-menu-shortcut-description = Ярлык { $app_title } { $app_version } в меню «Пуск»
