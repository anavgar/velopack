...
splash-body = جاري إعداد { $app_title }، الرجاء الانتظار...
...
setup-disk-space-insufficient = يتطلب { $app_title } مساحة قرص لا تقل عن { $required_space } للتثبيت. لا يتوفر سوى { $available_space }.
setup-windows-version-unsupported = يتطلب هذا المثبت نظام Windows 7 SP1 أو أحدث ولا يمكن تشغيله.
setup-embedded-zip-missing = تعذر العثور على ملف zip المضمن. الرجاء الاتصال بمؤلف التطبيق.
setup-os-version-required = يتطلب هذا التطبيق نظام Windows { $os_version } أو أحدث.
setup-cpu-arch-unsupported = هذا التطبيق ({ $machine_arch }) لا يدعم بنية المعالج لديك.
setup-stop-app-failed = فشل إيقاف التطبيق ({ $error })، الرجاء إغلاق التطبيق ومحاولة تشغيل المثبت مرة أخرى.
setup-remove-dir-failed = فشلت إزالة مجلد التطبيق الموجود، الرجاء إغلاق التطبيق ومحاولة تشغيل المثبت مرة أخرى. إذا استمرت المشكلة، فحاول إلغاء التثبيت أولاً عبر "البرامج والميزات" أو إعادة تشغيل الكمبيوتر.
setup-update-exe-missing = هذا المثبت يفتقد ملفًا ثنائيًا مهمًا (Update.exe). الرجاء الاتصال بمؤلف التطبيق.
setup-main-exe-missing = تعذر العثور على الملف التنفيذي الرئيسي في الحزمة. الرجاء الاتصال بمؤلف التطبيق.

# MSI Installer UI - Common
msi-dlg-title = إعداد { $app_title } { $app_version }
...
msi-welcome-title = مرحبًا بك في معالج إعداد { $app_title } { $app_version }
msi-welcome-description = سيقوم معالج الإعداد بتثبيت { $app_title } { $app_version } على الكمبيوتر. انقر فوق التالي للمتابعة، أو انقر فوق إلغاء الأمر لإنهاء معالج الإعداد.
msi-welcome-update-description = سيقوم معالج الإعداد بتحديث { $app_title } { $app_version } على الكمبيوتر. انقر فوق التالي للمتابعة، أو انقر فوق إلغاء الأمر لإنهاء معالج الإعداد.

# MSI Installer UI - Exit Dialog
msi-exit-title = اكتمل معالج إعداد { $app_title } { $app_version }
msi-exit-description = انقر فوق الزر إنهاء لإنهاء معالج الإعداد.
msi-exit-launch-checkbox = تشغيل { $app_title } { $app_version }

# MSI Installer UI - Prepare Dialog
msi-prepare-title = مرحبًا بك في معالج إعداد { $app_title } { $app_version }
...
msi-ready-install-title = جاهز لتثبيت { $app_title } { $app_version }
msi-ready-install-text = انقر فوق تثبيت لبدء التثبيت. انقر فوق السابق لمراجعة أي من إعدادات التثبيت أو تغييرها.
msi-ready-change-title = جاهز لتغيير { $app_title } { $app_version }
msi-ready-change-text = انقر فوق تغيير لبدء تغيير التثبيت. انقر فوق السابق لمراجعة أي من إعدادات التثبيت أو تغييرها.
msi-ready-repair-title = جاهز لإصلاح { $app_title } { $app_version }
msi-ready-repair-text = انقر فوق إصلاح لبدء الإصلاح. انقر فوق السابق لمراجعة أي من إعدادات التثبيت أو تغييرها.
msi-ready-remove-title = جاهز لإزالة { $app_title } { $app_version }
msi-ready-remove-text = انقر فوق إزالة لإزالة { $app_title } { $app_version } من الكمبيوتر. انقر فوق السابق لمراجعة أي من إعدادات التثبيت أو تغييرها.
msi-ready-update-title = جاهز لتحديث { $app_title } { $app_version }
...
msi-progress-installing-title = تثبيت { $app_title } { $app_version }
msi-progress-installing-text = الرجاء الانتظار أثناء قيام معالج الإعداد بتثبيت { $app_title } { $app_version }.
msi-progress-changing-title = تغيير { $app_title } { $app_version }
msi-progress-changing-text = الرجاء الانتظار أثناء قيام معالج الإعداد بتغيير { $app_title } { $app_version }.
msi-progress-repairing-title = إصلاح { $app_title } { $app_version }
msi-progress-repairing-text = الرجاء الانتظار أثناء قيام معالج الإعداد بإصلاح { $app_title } { $app_version }.
msi-progress-removing-title = إزالة { $app_title } { $app_version }
msi-progress-removing-text = الرجاء الانتظار أثناء قيام معالج الإعداد بإزالة { $app_title } { $app_version }.
msi-progress-updating-title = تحديث { $app_title } { $app_version }
msi-progress-updating-text = الرجاء الانتظار أثناء قيام معالج الإعداد بتحديث { $app_title } { $app_version }.
msi-progress-status = الحالة:

# MSI Installer UI - Maintenance Welcome Dialog
msi-maint-welcome-title = مرحبًا بك في معالج إعداد { $app_title } { $app_version }
msi-maint-welcome-description = سيسمح لك معالج الإعداد بإصلاح أو إزالة { $app_title } { $app_version }. انقر فوق التالي للمتابعة، أو انقر فوق إلغاء الأمر لإنهاء معالج الإعداد.
...
msi-maint-remove-text = إزالة { $app_title } { $app_version } من الكمبيوتر.
msi-maint-remove-disabled = الإزالة معطلة حاليًا.

# MSI Installer UI - Cancel Dialog
msi-cancel-text = هل تريد بالتأكيد إلغاء تثبيت { $app_title } { $app_version }؟
...
msi-error-dlg-title = معلومات مثبت { $app_title } { $app_version }

# MSI Installer UI - Fatal Error Dialog
msi-fatal-title = انتهى معالج إعداد { $app_title } { $app_version } قبل الأوان
msi-fatal-description1 = تمت مقاطعة إعداد { $app_title } { $app_version }. لم يتم تعديل النظام الخاص بك. لتثبيت هذا البرنامج في وقت لاحق، الرجاء تشغيل الإعداد مرة أخرى.
msi-fatal-description2 = انقر فوق الزر إنهاء لإنهاء معالج الإعداد.

# MSI Installer UI - User Exit Dialog
msi-user-exit-title = تمت مقاطعة معالج إعداد { $app_title } { $app_version }
msi-user-exit-description1 = تمت مقاطعة إعداد { $app_title } { $app_version }. لم يتم تعديل النظام الخاص بك. لتثبيت هذا البرنامج في وقت لاحق، الرجاء تشغيل الإعداد مرة أخرى.
...
msi-resume-title = استئناف معالج إعداد { $app_title } { $app_version }
msi-resume-description = سيقوم معالج الإعداد بإكمال تثبيت { $app_title } { $app_version } على الكمبيوتر. انقر فوق تثبيت للمتابعة، أو انقر فوق إلغاء الأمر لإنهاء معالج الإعداد.
msi-resume-btn-install = ت&ثبيت

# MSI Installer UI - Shortcut Descriptions
msi-desktop-shortcut-description = اختصار سطح المكتب لـ { $app_title } { $app_version }
msi-start-menu-shortcut-description = اختصار قائمة ابدأ لـ { $app_title } { $app_version }
