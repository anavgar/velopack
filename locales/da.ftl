...
splash-body = Konfigurerer { $app_title }, vent venligst...
...
setup-disk-space-insufficient = { $app_title } kræver mindst { $required_space } diskplads for at blive installeret. Der er kun { $available_space } tilgængelig.
setup-windows-version-unsupported = Denne installation kræver Windows 7 SP1 eller nyere og kan ikke køre.
setup-embedded-zip-missing = Den indlejrede zip-fil blev ikke fundet. Kontakt programmets udgiver.
setup-os-version-required = Dette program kræver Windows { $os_version } eller nyere.
setup-cpu-arch-unsupported = Dette program ({ $machine_arch }) understøtter ikke din CPU-arkitektur.
setup-stop-app-failed = Programmet kunne ikke stoppes ({ $error }). Luk programmet, og prøv at køre installationen igen.
setup-remove-dir-failed = Den eksisterende programmappe kunne ikke fjernes. Luk programmet, og prøv at køre installationen igen. Hvis problemet fortsætter, kan du prøve at afinstallere først via Programmer og funktioner eller genstarte computeren.
setup-update-exe-missing = Denne installation mangler en kritisk binær fil (Update.exe). Kontakt programmets udgiver.
setup-main-exe-missing = Den primære eksekverbare fil blev ikke fundet i pakken. Kontakt programmets udgiver.
...
msi-welcome-title = Velkommen til guiden { $app_title } { $app_version } Installation
msi-welcome-description = Guiden Installation installerer { $app_title } { $app_version } på computeren. Klik på Næste for at fortsætte, eller klik på Annuller for at afslutte guiden Installation.
msi-welcome-update-description = Guiden Installation opdaterer { $app_title } { $app_version } på computeren. Klik på Næste for at fortsætte, eller klik på Annuller for at afslutte guiden Installation.

# MSI Installer UI - Exit Dialog
msi-exit-title = Guiden { $app_title } { $app_version } Installation er fuldført
...
msi-prepare-title = Velkommen til guiden { $app_title } { $app_version } Installation
...
msi-ready-install-title = Klar til at installere { $app_title } { $app_version }
...
msi-ready-change-title = Klar til at ændre { $app_title } { $app_version }
...
msi-ready-repair-title = Klar til at reparere { $app_title } { $app_version }
...
msi-ready-remove-title = Klar til at fjerne { $app_title } { $app_version }
msi-ready-remove-text = Klik på Fjern for at fjerne { $app_title } { $app_version } fra computeren. Klik på Tilbage for at gennemgå eller ændre installationsindstillingerne.
msi-ready-update-title = Klar til at opdatere { $app_title } { $app_version }
...
msi-progress-installing-text = Vent, mens guiden Installation installerer { $app_title } { $app_version }.
msi-progress-changing-title = Ændrer { $app_title } { $app_version }
msi-progress-changing-text = Vent, mens guiden Installation ændrer { $app_title } { $app_version }.
msi-progress-repairing-title = Reparerer { $app_title } { $app_version }
msi-progress-repairing-text = Vent, mens guiden Installation reparerer { $app_title } { $app_version }.
msi-progress-removing-title = Fjerner { $app_title } { $app_version }
msi-progress-removing-text = Vent, mens guiden Installation fjerner { $app_title } { $app_version }.
msi-progress-updating-title = Opdaterer { $app_title } { $app_version }
msi-progress-updating-text = Vent, mens guiden Installation opdaterer { $app_title } { $app_version }.
msi-progress-status = Status:

# MSI Installer UI - Maintenance Welcome Dialog
msi-maint-welcome-title = Velkommen til guiden { $app_title } { $app_version } Installation
msi-maint-welcome-description = Guiden Installation giver dig mulighed for at reparere eller fjerne { $app_title } { $app_version }. Klik på Næste for at fortsætte, eller klik på Annuller for at afslutte guiden Installation.
...
msi-maint-remove-text = Fjerner { $app_title } { $app_version } fra computeren.
msi-maint-remove-disabled = Fjern er deaktiveret i øjeblikket.

# MSI Installer UI - Cancel Dialog
msi-cancel-text = Er du sikker på, at du vil annullere installationen af { $app_title } { $app_version }?
...
msi-error-dlg-title = { $app_title } { $app_version } Installationsoplysninger

# MSI Installer UI - Fatal Error Dialog
msi-fatal-title = Guiden { $app_title } { $app_version } Installation blev afsluttet før tid
msi-fatal-description1 = Installationen af { $app_title } { $app_version } blev afbrudt. Dit system er ikke blevet ændret. Hvis du vil installere programmet på et senere tidspunkt, skal du køre installationen igen.
msi-fatal-description2 = Klik på knappen Udfør for at afslutte guiden Installation.

# MSI Installer UI - User Exit Dialog
msi-user-exit-title = Guiden { $app_title } { $app_version } Installation blev afbrudt
msi-user-exit-description1 = Installationen af { $app_title } { $app_version } blev afbrudt. Dit system er ikke blevet ændret. Hvis du vil installere programmet på et senere tidspunkt, skal du køre installationen igen.
...
msi-resume-title = Fortsætter guiden { $app_title } { $app_version } Installation
msi-resume-description = Guiden Installation fuldfører installationen af { $app_title } { $app_version } på computeren. Klik på Installer for at fortsætte, eller klik på Annuller for at afslutte guiden Installation.
msi-resume-btn-install = &Installer

# MSI Installer UI - Shortcut Descriptions
msi-desktop-shortcut-description = Skrivebordsgenvej til { $app_title } { $app_version }
msi-start-menu-shortcut-description = Genvej til { $app_title } { $app_version } i menuen Start
